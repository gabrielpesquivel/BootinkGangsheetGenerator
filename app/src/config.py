...
SIZE_MAP = {
    ...
    'ContainsQ': {'font_size': 7.143 * MM_TO_PTS, 'offset_mm': 0.35, 'target_height_mm': 5}, # If text contains 'Q': 5mm
    'ContainsAccents': {'font_size': 7.143 * MM_TO_PTS, 'offset_mm': 0.35, 'target_height_mm': 5}, # If text contains accents: 5mm
    'ContainsSlashes': {'font_size': 6.857 * MM_TO_PTS, 'offset_mm': 0.35, 'target_height_mm': 4.8}, # If text contains slashes: 4.8mm
    'ContainsCommas': {'font_size': 6.857 * MM_TO_PTS, 'offset_mm': 0.35, 'target_height_mm': 4.8}, # If text contains commas: 4.8mm
